...
**TL;DR**
- The Obsidian Git plugin connects your note vault to Git [version control](/posts/setting-up-obsidian-git-for-automated-version-control/), giving you automatic [backups](/posts/explanation-of-obsidian-vault-structure-for-backups/), multi-[device sync](/posts/how-to-manage-obsidian-plugins-across-multiple-devices/), and full note history — all for free.
...
| **[Encryption](/posts/configuring-obsidian-for-end-to-end-encrypted-sync/) at Rest** | Depends on your repo settings | End-to-end encrypted |
...
**The Power User.** Writers working on long-form projects, [researchers](/posts/obsidian-vs-heptabase-for-visual-research-workflows/) managing hundreds of notes, and developers who already live in Git will find the obsidian version control capabilities genuinely useful. The ability to create a branch — a parallel copy of your vault — to experiment with restructuring a complex project without touching the stable version is something no other note tool offers at this price point.
