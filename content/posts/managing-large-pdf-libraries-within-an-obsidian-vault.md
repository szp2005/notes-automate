...
For academics, [researchers](/posts/obsidian-vs-heptabase-for-visual-research-workflows/), and serious [knowledge workers](/posts/understanding-the-difference-between-folders-and-tags-obsidian/), the Portable Document Format (PDF) remains the inescapable standard for sharing information. Whether you are dealing with academic papers, financial reports, technical manuals, or scanned archives, your personal [knowledge management](/posts/using-obsidian-for-long-term-evergreen-note-management/) (PKM) system eventually collides with the reality of PDF storage. 
