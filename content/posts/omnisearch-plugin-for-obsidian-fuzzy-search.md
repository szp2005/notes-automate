...
1. **Install Omnisearch:** Open Obsidian, navigate to **Settings > [Community](/posts/how-to-install-community-plugins-in-obsidian-mobile/) [plugins](/posts/periodic-notes-plugin-weekly-reviews/)**, and click **Browse**. Search for "Omnisearch" (developed by scambier) and click **Install**, followed by **Enable**.
